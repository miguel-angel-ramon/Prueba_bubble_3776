<c:when test="${imagenComercial.tipoReferencia == esCajaExpositoraRef}">

<jsp:include page="/WEB-INF/views/includes/pda_p01_header_modifPlanos.jsp" >
    <jsp:param value="pda_p33_imcCajaExp.css?version=${misumiVersion}" name="cssFile"></jsp:param>
    <jsp:param value="pda_p33Imc.js?version=${misumiVersion}" name="jsFileComun"></jsp:param>
    <jsp:param value="pda_p33ImcCajaExp.js?version=${misumiVersion}" name="jsFilePropio"></jsp:param>
    <jsp:param value="S" name="flechaMenu"></jsp:param>
    <jsp:param value="1" name="tipoReferencia"></jsp:param>
...
<!-- ----- Contenido de la JSP ----- -->
		...
		<div id="contenidoPagina">
			<form:form method="post" action="pdaP33Imc.do" commandName="pdaDatosImc">
				...
				<div id="pda_p33_cajaExp">

					<div id="pda_p33_imc_bloque_2">
						<div class="pda_p33_lbl_60">
							<label id="pda_p33_lbl_capacidad" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.capacidad" /></label>
						</div>
						<div class="pda_p33_input_70">
							<form:input path="capacidad" id="pda_p33_fld_capacidad" class="input70" type="text" disabled="true"/>
						</div>
						<div class="pda_p33_lbl_80">
							<label id="pda_p33_lbl_unidades" class="etiquetaCampo2"><spring:message code="pda_p33_modifPlanos.unidades" /></label>
						</div>
					</div>

						<div id="pda_p33_imc_bloque_3_1" class="pda_p33_imc_bloque_3_1">
							<div id="pda_p33_imc_bloque_3_1_1">
								<div class="pda_p33_lbl_80">
									<label id="pda_p33_lbl_multiplicador" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.multiplicador" /></label>
								</div>
							...
							<div id="pda_p33__bloque_3_1_2">
								<div class="pda_p33_lbl_80">
									<label id="pda_p33_lbl_facing" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.facing" /></label>
								</div>
								<div class="pda_p33_input_30">
									<form:input path="facing" id="pda_p33_fld_facing" class="input30" maxlength="3" disabled="true" type="text"/>
								</div>
							</div>
						</div>
						...
						<div id="pda_p33_imc_bloque_3_3">
							<div id="pda_p33_imagenMinimaComercial">
								<label id="pda_p33_lbl_imagenMinimaComercial" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.imagenMinimaComercial" /></label>
								<form:input path="imc" id="pda_p33_fld_imagenMinimaComercial"  disabled="true"  type="text"/>
							</div>
						</div>
					</div>
				</div>
				<div id="pda_p33_imc_bloque_4">
					<div id="pda_p33_imc_bloque_4_1">
						<div class="pda_p33_lbl_80">
							<label id="pda_p33_lbl_facAncho" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.fac.ancho.cajas" /></label>
						</div>
						<div class="pda_p33_input_30">
							<form:input path="facAncho" id="pda_p33_fld_facAncho" class="input30 inputEditable" maxlength="3" type="number"/>
						</div>
					</div>
					<div id="pda_p33_imc_bloque_4_2">
						<div class="pda_p33_imc_bloque_4_2_campos">
							<label id="pda_p33_lbl_facAlto" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.fac.alto.cajas" /></label>
						</div>
						<div class="pda_p33_imc_bloque_4_2_campos">
							<form:input path="facAlto" id="pda_p33_fld_facAlto" class="input30 inputEditable" maxlength="3" type="number"/>
						</div>
					</div>
				</div>			
