	...
	<!-- ----- Contenido de la JSP ----- -->
		...
		<div id="contenidoPagina">
			...
			<div id="pda_p20_fotoAmpliada_contenido">
				...
				<form id="pda_p20_fotoAmpliadaDatosReferencia_form" action="${actionP20}" method="post">
						<input type="hidden" id="codArtCab" name="codArtCab" value="${codArticuloFoto}">	
						<input type="hidden" id="fechaDesde" name="fechaDesde" value="${fechaDesde}">						
						<input type="hidden" id="fechaHasta" name="fechaHasta" value="${fechaHasta}">											
				</form>						
			</div>
