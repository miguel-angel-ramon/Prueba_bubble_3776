...
<jsp:include page="/WEB-INF/views/includes/pda_p01_header.jsp">
    <jsp:param name="cssFile" value="pda/packingList/pda_p111_errorPackingList.css?version=${misumiVersion}"></jsp:param>
    <jsp:param name="jsFile" value="pda/packingList/pda_p111ErrorPackingList.js?version=${misumiVersion}"></jsp:param>
...
<!-- ----- Contenido de la JSP ----- -->
		...
		<div id="contenidoPagina">
			...
			<div id="pda_p111_errorPackingList_titulo">
				<label id="pda_p111_errorPackingList_lbl_titulo"><spring:message code="pda_p107_entradasPalets.titulo" /></label>
			</div>

			<div id="pda_p111_errorPackingList_contenido">
				<form:form id="pdaP111ErrorPackingList" action="${controlVolver}" method="post">
