...
<jsp:include page="/WEB-INF/views/includes/pda_p01_header_modifPlanos.jsp" >
    <jsp:param value="pda_p33_imcFFPP.css?version=${misumiVersion}" name="cssFile"></jsp:param>
    <jsp:param value="pda_p33Imc.js?version=${misumiVersion}" name="jsFileComun"></jsp:param>
    <jsp:param value="pda_p33ImcFFPP.js?version=${misumiVersion}" name="jsFilePropio"></jsp:param>
    <jsp:param value="S" name="flechaMenu"></jsp:param>
    <jsp:param value="3" name="tipoReferencia"></jsp:param>
    <jsp:param value="pdaP33Imc.do" name="actionRef"></jsp:param>
</jsp:include>
<!-- ----- Contenido de la JSP ----- -->

PROCEDE-2:<c:out value="${procede}"/>
		...
		<div id="contenidoPagina">
			<form:form method="post" action="pdaP33Imc.do" commandName="pdaDatosImc">
				...
				<div id="pda_p33_imc_bloque_2">
					<div id="pda_p33_imc_bloque_2_1" class="pda_p33_imc_bloque_2_1">
						<div id="pda_p33_imc_bloque_2_1_1">
							...
							<div class="pda_p33_input_30">
								<form:input path="capacidad" id="pda_p33_fld_capacidad" class="input30" type="text" disabled="true"/>
							</div>
						</div>
						<div id="pda_p33__bloque_2_1_2">
							<div class="pda_p33_lbl_80">
								<label id="pda_p33_lbl_facing" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.facing" /></label>
							</div>
							<div class="pda_p33_input_30">
								<form:input path="facing" id="pda_p33_fld_facing" class="input30" maxlength="3"/>
							</div>
						</div>
						<div id="pda_p33__bloque_2_1_3">
							<div class="pda_p33_lbl_80">
								<label id="pda_p33_lbl_facAncho" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.ancho" /></label>
							</div>
							<div class="pda_p33_input_30">
