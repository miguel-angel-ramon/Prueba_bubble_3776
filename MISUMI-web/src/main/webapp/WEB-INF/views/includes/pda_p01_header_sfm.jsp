...
<script src="./misumi/scripts/jqueryCore/jquery.numberformatter-1.2.3.js" type="text/javascript"></script>
<script src="./misumi/scripts/pda_p21Sfm.js" type="text/javascript"></script>
<script src="./misumi/scripts/pda_p27Facing.js" type="text/javascript"></script>
			...
			<div id="cabecera">
				...
				<c:choose>
					<c:when test="${empty (pdaDatosCab.origenConsulta)}">
						<form:form method="post" action="pdaP21Sfm.do" commandName="pdaDatosCab">
