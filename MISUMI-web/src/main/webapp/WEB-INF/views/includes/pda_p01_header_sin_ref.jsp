...
<!-- Se cierra en pda_p02_footer.jsp -->
		...
		<div id="marco">  <!-- Se cierra en pda_p02_footer.jsp -->
			...
			<div id="cabecera">
				...
				<div id="pda_p01_referencia" style="display: none;">
					<label id="pda_p01_lbl_infoRef" class="etiquetaCampoNegrita" ><spring:message code="pda_p01_header.referencia" /></label>
					<input id="pda_p01_txt_infoRef" class="input50" type="text"/>
					<input id="pda_p01_txt_descRef" class="input85" type="text" disabled="disabled"/>
				</div>
