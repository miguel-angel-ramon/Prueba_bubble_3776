...
<link href="./misumi/styles/pda_p02_header.css?version=${misumiVersion}" media="all" type="text/css" rel="stylesheet" />
...
<script src='./misumi/scripts/pda_p02Header.js?version=${misumiVersion}' type='text/javascript'></script>
					...
					<c:choose>
						<c:when test="${param.flechaMenu eq 'S'}">
							<c:choose>
								...
								<c:when test="${not empty param.actionRef && (param.actionRef eq 'pdaP109ConsultasReferencia.do')}">
								    <c:choose>
								        <c:when test="${existeEntradasPalets}">
								            <a href="./pdaP109ConsultasReferencia.do" id="pda_p10_volver">
				...
				<c:if test="${not empty param.actionRef}">
					<c:choose>
						...
						<c:otherwise>
							...
							<c:when test="${(param.actionRef eq 'pdaP109ConsultasReferencia.do') and (not existeEntradasPalets)}">
        <div id="pda_p01_datosArticulo">
            <div id="pda_p01_referencia">
                <label id="pda_p01_lbl_infoMat" class="etiquetaCampoNegrita">
                    <spring:message code="pda_p01_header.referencia" />
                </label>
                <form:input path="codArtCab" id="pda_p01_txt_infoRef" class="input100" type="text" />

                <div id="pda_p01_referencia_botonera">
                    <input type="submit" id="pda_p01_btn_aceptar" name="actionIntroRef" class="botonFormulario"
                           value='<spring:message code="pda_p01_header.aceptar"/>' title='<spring:message code="pda_p01_header.aceptarTitulo" />' />
                </div>
            </div>

            <div id="pda_p108_consultaPorMatricula_areaLinks">
                <div style="text-align: center;">
                    <hr class="hrFiltradoPL">
                    <span class="filtradoPckListTXT">
                        <spring:message code="pda_p01_header.filtradoPckList" />
                    </span>
                </div>    
                
                <br>   

                <div id="pda_p01_fechaDesde">
                    <label for="fechaDesde" style="font-weight: bold; font-size: 11px;">Fecha Desde:</label>
                    <form:input type="text" path="fechaDesde" id="fechaDesde" class="input100" 
                                value="${pdaDatosCab.fechaDesde}" />
                </div>
                <br>

                <div id="pda_p01_fechaHasta">
                    <label for="fechaHasta" style="font-weight: bold; font-size: 11px;">Fecha Hasta:</label>
                    <form:input type="text" path="fechaHasta" id="fechaHasta" class="input100" 
                                value="${pdaDatosCab.fechaHasta}" />
                </div>
            </div>
        </div>
    </c:when>

    <c:when test="${((param.actionRef eq 'pdaP109ConsultasReferencia.do') and (existeEntradasPalets))}">
        <div id="pda_p01_datosArticulo">
        </div>
    </c:when>
