...
<script src="./misumi/scripts/pda_p30CorrStockPCS.js" type="text/javascript"></script>
		...
		<div id="marco">  <!-- Se cierra en pda_p02_footer.jsp -->
			...
			<div id="cabecera">
				<div id="pda_p01_datosCentroMenu">
					...
					<form:form method="post" action="pdaP30CorrStockPCS.do" commandName="pdaDatosCab">
