...
<script src="./misumi/scripts/pda_p25VentaAnticipada.js" type="text/javascript"></script>
		...
		<div id="marco">  <!-- Se cierra en pda_p02_footer.jsp -->
			...
			<div id="cabecera">
				<div id="Logo">
					...
					<img src="./misumi/images/logo_misumi_pda.gif" style="vertical-align: middle;" class="imagenLogoCabecera" title='<spring:message code="pda_p01_header.salir" />'/>
				</div>
				...
				<form:form method="post" action="pdaP25VentaAnticipada.do" commandName="pdaDatosCab">				
				<div id="pda_p01_referencia">
					<label id="pda_p01_lbl_infoRef" class="etiquetaCampoNegrita" ><spring:message code="pda_p01_header.referencia" /></label>
						...
						<form:input path="descArtCabConCodigo" id="pda_p01_txt_descRef" class="input120" disabled="true" type="text"/>
				</div>
