...
<jsp:include page="/WEB-INF/views/includes/pda_p01_header.jsp" >
    <jsp:param value="pda_p98_datosReferenciaSelOperativa.css?version=${misumiVersion}" name="cssFile"></jsp:param>
    <jsp:param value="pda_p98_datosReferenciaSelOperativa.js?version=${misumiVersion}" name="jsFile"></jsp:param>
...
<!-- ----- Contenido de la JSP ----- -->
		...
		<div id="contenidoPagina">
			...
			<div id="pda_p98_DatosReferenciaSelOperativa_bloque2">
				...
				<a href="./pdaP12DatosReferencia.do?pdaP12DatosReferencia.do?menu=PDA_DR&cleanAll=Y"><spring:message code="pda_p98_DatosReferenciaSelOperativa.empezarDesdeCero" /></a>
			</div>
			<div id="pda_p98_DatosReferenciaSelOperativa_bloque3">
				...
				<a href="./pdaP12DatosReferencia.do?menu=PDA_DR	"><spring:message code="pda_p98_DatosReferenciaSelOperativa.continuar" /></a>
			</div>
