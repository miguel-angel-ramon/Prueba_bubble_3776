				...
				<c:choose>
					<c:when test="${data.flgColorImplantacion eq 'VERDE'}">
						<legend id="pda_p12_imagenComercialLegendVerde"> 
							<span>
								<a id="pda_p12_imagenComercialSpanVerde" href="./pdaP17implantacionPopup.do?procede=pdaP99SacadaRestos&codArt=${data.codArt}&implantacion=${data.implantacion}&flgColorImplantacion=${data.flgColorImplantacion}&origenGISAE=${origenGISAE}">
					...
					<c:when test="${data.flgColorImplantacion eq 'ROJO'}">
						<legend id="pda_p12_imagenComercialLegendRojo">
							<span>
								<a id="pda_p12_imagenComercialSpanRojo" href="./pdaP17implantacionPopup.do?procede=pdaP99SacadaRestos&codArt=${data.codArt}&implantacion=${data.implantacion}&flgColorImplantacion=${data.flgColorImplantacion}&origenGISAE=${origenGISAE}">
									<spring:message code="pda_p12_datosReferencia.implantacionCajas" />
								</a>
							</span>
						</legend>
								...
								<c:when test="${imc.facingModificable eq 1}">
									<c:choose> 
										...
										<c:when test="${empty guardadoImc}">
											<a href="./pdaP33Imc.do?codArt=${data.codArt}&procede=pdaP99SacadaRestos">
						...
						<c:choose>
							<c:when test="${imc.tipoReferencia eq esCajaExpositoraRef}">
									<legend id="pda_p12_imagenComercialLegend">
										...
										href="./pdaP17implantacionPopup.do?procede=pdaP99SacadaRestos&codArt=${data.codArt}&implantacion=${data.implantacion}&flgColorImplantacion=${data.flgColorImplantacion}&origenGISAE=${origenGISAE}">
							...
							<c:if test = "${(data.pedidoActivo eq 'S') && (data.capacidad1 ne null && data.capacidad1 ne 0 && data.capacidad1 ne '') || (data.facing1 ne null && data.facing1 ne 0 && data.facing1 ne '')}">
								<div id="pda_p12_datosReferencia_bloque5_cap1fac1">
									<div id="pda_p12_datosReferencia_bloque5_cap1">
										...
										<label id="pda_p12_lbl_capacidad1Val" class="valorCampo"> ${data.capacidad1} </label>
									</div>
									<div id="pda_p12_datosReferencia_bloque5_fac1">
										...
										<label id="pda_p12_lbl_facing1Val" class="valorCampo"> ${data.facing1} </label>
									</div>
								</div>
							</c:if>		
								...
								<c:choose>
									...
									<c:when test="${empty guardadoSfm}">
										<label id="pda_p12_lbl_sfm" class="etiquetaCampoNegrita"><a
											href="./pdaP21Sfm.do?procede=pdaP99SacadaRestos&codArt=${data.codArt}&origen=1&origenGISAE=${origenGISAE}"><spring:message
													code="pda_p12_datosReferencia.sfm" /></a></label>
										<label id="pda_p12_lbl_sfmVal" class="valorCampo">${imc.sfm}</label>
									</c:when>
									<%-- El link sale en verde. Significa que se ha ido a SFM y se ha vuelto tras guardar. --%>
									<c:otherwise>
										<label id="pda_p12_lbl_sfm" class="etiquetaCampoNegrita"><a
											href="./pdaP21Sfm.do?procede=pdaP99SacadaRestos&codArt=${data.codArt}&origen=1&origenGISAE=${origenGISAE}"><span
								...
								<c:when test="${pageData.mmc eq 'S'}">
									<c:if test="${empty guardadoSfm }">
										<label id="pda_p12_lbl_facingEnlace"
											...
											href="./pdaP21Sfm.do?procede=pdaP99SacadaRestos&codArt=${data.codArt}&origen=1&origenGISAE=${origenGISAE}">
											<spring:message	code="pda_p12_datosReferencia.facingLineal" /></a></label>
										<label id="pda_p12_lbl_facingVal" class="valorCampo">${imc.facing}</label>
									</c:if>
					...
					<div id="pda_p12_datosReferencia_bloque5_facCap">
							...
							<c:choose>
								...
								<c:when test="${pageData.mmc eq 'S'}">
									<c:if test="${empty guardadoSfm}">
										...
										<label id="pda_p12_lbl_capacidadVal" class="valorCampo">${imc.capacidad}</label>
									</c:if>
									<c:if test="${not empty guardadoSfm}">
										<label id="pda_p12_lbl_capacidadEnlace"
											class="etiquetaCampoNegrita"> <a
						...
						<div id="pda_p12_datosReferencia_bloque5_facingDerecha">
							<label id="pda_p12_lbl_facing" class="etiquetaCampoNegrita"><spring:message
								...
								id="pda_p12_lbl_facingVal" class="valorCampo">${imc.facing}</label>
						</div>
					</div>
					<%-- VALOR DE MULTIPLICADOR E IMC --%>
					<div id="pda_p12_datosReferencia_bloque5_multipImcDerecha">
