<c:when test="${imagenComercial.tipoReferencia == esUnitariaRef}">

<jsp:include page="/WEB-INF/views/includes/pda_p01_header_modifPlanos.jsp" >
    <jsp:param value="pda_p33_imcUnitaria.css?version=${misumiVersion}" name="cssFile"></jsp:param>
    <jsp:param value="pda_p33Imc.js?version=${misumiVersion}" name="jsFileComun"></jsp:param>
    <jsp:param value="pda_p33ImcUnitaria.js?version=${misumiVersion}" name="jsFilePropio"></jsp:param>
			...
			<form:form method="post" action="pdaP33Imc.do" commandName="pdaDatosImc">
				...
				<div id="pda_p33_imc_bloque_4">
					<div id="pda_p33_imc_bloque_4_1">
						<div class="pda_p33_lbl_80">
							<label id="pda_p33_lbl_facAncho" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.fac.ancho" /></label>
						</div>
						<div class="pda_p33_input_30">
							<form:input path="facAncho" id="pda_p33_fld_facAncho" class="input30" maxlength="3" type="number" onkeypress="return isNumberKey(event)"/>
						</div>
					</div>
					<div id="pda_p33_imc_bloque_4_2">
						<div class="pda_p33_imc_bloque_4_2_campos">
							<label id="pda_p33_lbl_facAlto" class="etiquetaCampo"><spring:message code="pda_p33_modifPlanos.fac.alto" /></label>
						</div>
						<div class="pda_p33_imc_bloque_4_2_campos">
							<form:input path="facAlto" id="pda_p33_fld_facAlto" class="input30" maxlength="3" type="number" onkeypress="return isNumberKey(event)"/>
						</div>
					</div>
				</div>			
