window.onload = function(){
	...
	// Inicializo la página de Prehuecos Lineales
	if(typeof(initializeScreen_p115) !== 'undefined'){
		//Inicializo la página p115
		initializeScreen_p115();
	}
	
	// Inicializo la página de Prehuecos Lineales
	if(typeof(initializeScreen_p118) !== 'undefined'){
		//Inicializo la página p118
		initializeScreen_p118();
	}
