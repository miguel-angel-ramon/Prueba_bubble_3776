 ...
 */
function PedidoAdicionalM (codCentro, grupo1, grupo2, grupo3, codArticulo, descriptionArt, clasePedido, fechaInicio, fechaFin, capMax,
		capMin, cantidad1, cantidad2, cantidad3, uniCajaServ, excluir, listadoSeleccionados, esPlanograma, identificador, mca, stock, listaFiltroClasePedido, noGestionaPbl, identificadorSIA, descPeriodo,espacioPromo){
	...
	//Metodos	
	this.preparePedidoAdicionalMToJsonObject = function preparePedidoAdicionalMToJsonObject(){
		var jsonObject = null;
