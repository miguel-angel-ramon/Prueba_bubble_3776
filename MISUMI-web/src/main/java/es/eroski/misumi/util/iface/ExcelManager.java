...
public interface ExcelManager {
	...
	/**
	 * Exporta en un EXCEL los filtros y resultados de pantalla.
	 * 
	 * @param lista
	 * @param headers
	 * @param model
	 * @param messageSource
	 * @param vArtCentroAlta
	 * @param vAgruComerGrupoArea
	 * @param vAgruComerGrupoSection
	 * @param vAgruComerGrupoCategory
	 * @param vAgruComerGrupoSubCategory
	 * @param vAgruComerGrupoSegment
	 * @param marcaMaestroCentro
	 * @param catalogo
	 * @param pedir
	 * @param pedible
	 * @param tipolistado
	...
	public void exportAltaCatalogo(List<GenericExcelVO> lista, String[] headers, String[] model,
			...
			String catalogo, String pedir, String pedible, String tipolistado, String facingCero,
	...
	public void exportMisPedidosCantPed(List<GenericExcelVO> lista, String[] headers, String[] model,
			...
			VAgruComerRef vAgruComerGrupoSection, VAgruComerRef vAgruComerGrupoCategory,
			SeguimientoMiPedidoDetalle seguimientoMiPedidoDetalle,Boolean isCentroVegalsa, HttpServletResponse response) throws Exception;
	...
	public void exportDetallePedido(List<GenericExcelVO> lista, String[] headers, String[] columnModel,
	...
	/**
	 * Exporta en un EXCEL los filtros y resultados de pantalla cuando se trata de Textil.
	 * 
	 * @param lista
	 * @param headers
	 * @param model
	...
	/**
	 * Exportacion para la lista de detalle de calendario de pedido Vegalsa
	 * @param lstDiasCalendario
	 * @param centro
	 * @param response
	 * @throws Exception
	 */
	...
	/**
	 * Exportaci�n de las referencias con Facing Cero.
	 * 
	 * @param lista
	 * @param model
	 * @param widths
	...
	public void exportFacingCero( List<VArtSfm> lista, String[] model, Integer[] widths
			, MessageSource messageSource, Centro centro, Long grupo1, String descArea
			, HttpServletResponse response
			) throws Exception;
	...
	public void exportConsumoRapido(String nombreCentro, Long area, Long seccion, String fechaIni, String fechaFin, List<ConsumoRapido> listado, String[] headers, String[] model,
