...
public interface VConfirmacionPedidoDao {
	...
	/**
	 * MISUMI-355 Devuelve el numero de registros encontrados con cod_soc=13 (Centro
	 * Vegalsa) para el cod_centro indicado. 0 = No centro Vegalsa >0 = Centro
	 * Vegalsa
	 * 
	 * @param codCentro
	 * @return
	...
	/**
	 * MISUMI-674. Devuelve el numero de lineas de pedido con ajuste y con fecha de
	 * entrega en tienda mayor o igual a la fecha del sistema para un centro dado.
	 * 
	 * @param codCentro
	 * @return
	 */
	long findLineasPedidoAjusteCont(Long codCentro);
