...
@Service(value = "servicePdfInformeDevolucionOrdenRetiradaHeaderFooterPageEvent")
public class PdfInformeDevolucionOrdenRetiradaHeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    private String nombreOrdenRetirada;
	...
	public void onStartPage(PdfWriter writer, Document document) {
		...
		try {
			...
			logger.error("Exporting pdf Informe Devolucion Orden Retirada: PdfInformeDevolucionOrdenRetiradaHeaderFooterPageEvent.onStartPage tablaCabecera");
		...
		try {
			...
			// título
			args.clear();
			args.add(nombreOrdenRetirada);
			String strTituloOrdenRetirada = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.titulo", args.toArray(), locale);
			Chunk chunkTituloOrdenRetirada = new Chunk(strTituloOrdenRetirada, this.fontCabeceraTitulo);
			Paragraph pTituloOrdenRetirada = new Paragraph();
			pTituloOrdenRetirada.add(chunkTituloOrdenRetirada);
			pTituloOrdenRetirada.setAlignment(Element.ALIGN_CENTER);
			PdfPCell cellTitulo = new PdfPCell();
			cellTitulo.addElement(pTituloOrdenRetirada);
			...
			logger.error("Exporting pdf Informe Devolucion Orden Retirada: PdfInformeDevolucionOrdenRetiradaHeaderFooterPageEvent.onStartPage tablaCabeceraTitulo");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
		}
		...
		try {
			...
			String strFechaLimiteFormato = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.fecha.limite.formato", null, locale);
	        SimpleDateFormat formatoFechaLimite = new SimpleDateFormat(strFechaLimiteFormato);//Martes 4-ABR
	        if (fechaLimite == null){
	        	fechaLimite = new Date();
	        }
			String strFechaLimite = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.fecha.limite", null, locale);
			...
			// observaciones
			String strObservacionesLabel = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.observaciones", null, locale);
			...
			// centro
			String strCentroLabel = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.centro", null, locale);
			...
			String strLocalizadorLabel = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.localizador", null, locale);
			...
			// abono
			String strAbono = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.abono", null, locale);
			...
			// recogida
			String strRecogidaLabel = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.recogida", null, locale);
			...
			// fecha
			String strFechaFormato = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.fecha.formato", null, locale);
			...
			String strFecha = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.fecha", null, locale);
			...
			// hora
			String strHoraFormato = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.hora.formato", null, locale);
			...
			String strHora = messageSource.getMessage("pdf_devoluciones.ordenRetirada.cabecera.hora", null, locale);
			...
			logger.error("Exporting pdf Informe Devolucion Orden Retirada: PdfInformeDevolucionOrdenRetiradaHeaderFooterPageEvent.onStartPage tablaCabeceraDatos");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
		}
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        try {
			...
			logger.error("Exporting pdf Informe Devolucion Orden Retirada: PdfInformeDevolucionOrdenRetiradaHeaderFooterPageEvent.onEndPage");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
        }
    }
    ...
    public void onCloseDocument(PdfWriter writer, Document document) {
        ...
        try {
			...
			logger.error("Exporting pdf Informe Devolucion Orden Retirada: PdfInformeDevolucionOrdenRetiradaHeaderFooterPageEvent.onCloseDocument");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
        }
    }
	...
	public String getNombreOrdenRetirada() {
		return nombreOrdenRetirada;
	}

	public void setNombreOrdenRetirada(String nombreOrdenRetirada) {
		this.nombreOrdenRetirada = nombreOrdenRetirada;
	}
