...
@Service(value = "servicePdfInformeDevolucionCreadaCentroHeaderFooterPageEvent")
public class PdfInformeDevolucionCreadaCentroHeaderFooterPageEvent extends PdfPageEventHelper {
	...
	public void onStartPage(PdfWriter writer, Document document) {
		...
		try {
			...
			logger.error("Exporting pdf Informe Devolucion Creada por el Centro: PdfInformeDevolucionCreadaCentroHeaderFooterPageEvent.onStartPage tablaCabecera");
		...
		try {
			...
			String strTituloCampana = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.titulo", args.toArray(), locale);
			...
			logger.error("Exporting pdf Informe Devolucion Creada por el Centro: PdfInformeDevolucionCreadaCentroHeaderFooterPageEvent.onStartPage tablaCabeceraTitulo");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
		}
		...
		try {
			...
			Paragraph pFechaLimite = null;
		
			
			// observaciones
			String strObservacionesLabel = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.observaciones", null, locale);
			...
			// centro
			String strCentroLabel = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.centro", null, locale);
			...
			// seccion
			String strSeccionLabel = messageSource.getMessage("pdf_devoluciones.creadaCentro.seccion", null, locale);
			...
			String strLocalizadorLabel = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.localizador", null, locale);
			...
			// abono
			String strAbono = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.abono", null, locale);
			...
			// recogida
			String strRecogidaLabel = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.recogida", null, locale);
			...
			// fecha
			String strFechaFormato = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.fecha.formato", null, locale);
			...
			String strFecha = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.fecha", null, locale);
			...
			// hora
			String strHoraFormato = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.hora.formato", null, locale);
			...
			String strHora = messageSource.getMessage("pdf_devoluciones.creadaCentro.cabecera.hora", null, locale);
			...
			logger.error("Exporting pdf Informe Devolucion Creada por el Centro: PdfInformeDevolucionCreadaCentroHeaderFooterPageEvent.onStartPage tablaCabeceraDatos");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
		}
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        try {
			...
			logger.error("Exporting pdf Informe Devolucion Creada por el Centro: PdfInformeDevolucionCreadaCentroHeaderFooterPageEvent.onEndPage");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
        }
    }
    ...
    public void onCloseDocument(PdfWriter writer, Document document) {
        ...
        try {
			...
			logger.error("Exporting pdf Informe Devolucion Creada por el Centro: PdfInformeDevolucionCreadaCentroHeaderFooterPageEvent.onCloseDocument");
			logger.error(StackTraceManager.getStackTrace(e));
            throw new ExceptionConverter(e);
        }
    }
