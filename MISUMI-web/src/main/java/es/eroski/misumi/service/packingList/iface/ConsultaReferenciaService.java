 ...
 *
 */
public interface ConsultaReferenciaService {
     ...
     */
    public RdoListarArticulosWrapper listarArticulosPorMatricula(String matricula, String ceco, String fechaDesdeInput, String fechaHastaInput);
