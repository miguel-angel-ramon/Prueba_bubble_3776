...
public class VRotacionRefEuros implements Serializable{
	...
	public VRotacionRefEuros() {
		super();
	}

	public VRotacionRefEuros(Long codCentro, Long codArt, Long grupo1, Long grupo2, Long grupo3, Long grupo4, Long grupo5,
