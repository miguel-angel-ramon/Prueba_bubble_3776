/**
 * ExclusionVentaInsertarRequestType.java
 *
...
public class ExclusionVentaInsertarRequestType  implements java.io.Serializable {
    private es.eroski.misumi.model.pedidosPBLWS.ExclusionVentasType[] listaExclusionVentas;

    public ExclusionVentaInsertarRequestType() {
    }
    ...
    /**
     * Gets the listaExclusionVentas value for this ExclusionVentaInsertarRequestType.
     * 
    ...
    /**
     * Sets the listaExclusionVentas value for this ExclusionVentaInsertarRequestType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExclusionVentaInsertarRequestType)) return false;
        ExclusionVentaInsertarRequestType other = (ExclusionVentaInsertarRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExclusionVentaInsertarRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/ExclusionVentasPBL/ExclusionVentas", "ExclusionVentaInsertarRequestType"));
