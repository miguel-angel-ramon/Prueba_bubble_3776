...
public class InventarioRotativo implements Serializable{
	...
	private Double camaraStock;
	private Long camaraBandeja;
	private Double salaStock;
	private Long salaBandeja;
	...
	public InventarioRotativo() {
		super();
		// TODO Auto-generated constructor stub
	}

	public InventarioRotativo(Long codCentro, String codMac, Long codArea,
			Long codSeccion, Long codArticulo, String flgUnica,
			Long codArticuloRela, String flgStockPrincipal,
			String flgNoGuardar, Double camaraStock, Long camaraBandeja,
			Double salaStock, Long salaBandeja, Long proporRefCompra,
	...
	public Double getCamaraStock() {
		return this.camaraStock;
	}

	public void setCamaraStock(Double camaraStock) {
		this.camaraStock = camaraStock;
	}

	public Long getCamaraBandeja() {
		return this.camaraBandeja;
	}

	public void setCamaraBandeja(Long camaraBandeja) {
		this.camaraBandeja = camaraBandeja;
	}

	public Double getSalaStock() {
		return this.salaStock;
	}

	public void setSalaStock(Double salaStock) {
		this.salaStock = salaStock;
	}

	public Long getSalaBandeja() {
		return this.salaBandeja;
	}

	public void setSalaBandeja(Long salaBandeja) {
		this.salaBandeja = salaBandeja;
	}
