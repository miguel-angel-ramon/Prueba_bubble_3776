/**
 * ModificarStockRequestType.java
 *
...
public class ModificarStockRequestType  implements java.io.Serializable {
    private java.math.BigInteger codigoCentro;

    private es.eroski.misumi.model.stockTiendaWS.ReferenciaModType[] listaReferencias;

    public ModificarStockRequestType() {
    }

    public ModificarStockRequestType(
           java.math.BigInteger codigoCentro,
           es.eroski.misumi.model.stockTiendaWS.ReferenciaModType[] listaReferencias) {
    ...
    /**
     * Gets the codigoCentro value for this ModificarStockRequestType.
     * 
     * @return codigoCentro
     */
    ...
    /**
     * Sets the codigoCentro value for this ModificarStockRequestType.
     * 
     * @param codigoCentro
     */
    ...
    /**
     * Gets the listaReferencias value for this ModificarStockRequestType.
     * 
     * @return listaReferencias
     */
    public es.eroski.misumi.model.stockTiendaWS.ReferenciaModType[] getListaReferencias() {
        return listaReferencias;
    }


    /**
     * Sets the listaReferencias value for this ModificarStockRequestType.
     * 
     * @param listaReferencias
     */
    public void setListaReferencias(es.eroski.misumi.model.stockTiendaWS.ReferenciaModType[] listaReferencias) {
        this.listaReferencias = listaReferencias;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ModificarStockRequestType)) return false;
        ModificarStockRequestType other = (ModificarStockRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ModificarStockRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/GCPV/schema/StockTienda201907", "ModificarStockRequestType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/GCPV/schema/StockTienda201907", "ReferenciaModType"));
        elemField.setNillable(false);
