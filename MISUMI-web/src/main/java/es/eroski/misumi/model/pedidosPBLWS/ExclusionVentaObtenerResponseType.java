/**
 * ExclusionVentaObtenerResponseType.java
 *
...
public class ExclusionVentaObtenerResponseType  implements java.io.Serializable {
    private es.eroski.misumi.model.pedidosPBLWS.ExclusionVentasType[] listaExclusionVentas;

    public ExclusionVentaObtenerResponseType() {
    }
    ...
    /**
     * Gets the listaExclusionVentas value for this ExclusionVentaObtenerResponseType.
     * 
    ...
    /**
     * Sets the listaExclusionVentas value for this ExclusionVentaObtenerResponseType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExclusionVentaObtenerResponseType)) return false;
        ExclusionVentaObtenerResponseType other = (ExclusionVentaObtenerResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExclusionVentaObtenerResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/ExclusionVentasPBL/ExclusionVentas", "ExclusionVentaObtenerResponseType"));
