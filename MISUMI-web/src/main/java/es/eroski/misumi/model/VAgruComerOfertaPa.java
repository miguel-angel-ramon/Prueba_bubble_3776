...
public class VAgruComerOfertaPa implements Serializable{
	...
	public VAgruComerOfertaPa() {
	    super();
	}

	public VAgruComerOfertaPa(Long codCentro, Long anoOferta, Long numOferta, String nivel, Long grupo1,
			Long grupo2, Long grupo3, Long grupo4, Long grupo5,
			String descripcion, Date fechaGen) {
		super();
