...
public class OfertaVigente implements Serializable{
	...
	public OfertaVigente() {
	    super();
	}

	public OfertaVigente(Long codCentro, Long codArt, Long anoOferta, Long numOferta,
	...
	public OfertaVigente( Long anoOferta, Long numOferta) {
		super();
		this.anoOferta = anoOferta;
		this.numOferta = numOferta;
	}
