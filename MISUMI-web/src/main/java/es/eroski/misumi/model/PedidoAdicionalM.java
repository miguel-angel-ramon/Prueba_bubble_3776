...
public class PedidoAdicionalM implements Cloneable,Serializable{
	...
	public PedidoAdicionalM() {
	    super();
	}
	
	public  PedidoAdicionalM clone() throws CloneNotSupportedException{
		return (PedidoAdicionalM)super.clone();
	}

	public PedidoAdicionalM(Long codCentro, Long identificador, Long grupo1, Long grupo2, Long grupo3,
			...
			Double cantidad1, Double cantidad2, Double cantidad3, Double uniCajaServ,
			boolean excluir, int indice, String usuario, String modificable, String modificableIndiv, String tipoPedido,
			String borrable, String codError, String descError, String codigoRespuesta, String descripcionRespuesta, 
			List<CamposSeleccionadosM> listadoSeleccionados, String noGEstionaPbl, Long identificadorSIA) {
		super();
	...
	public Double getCantidadPilada() {
		return this.cantidadPilada;
	}

	public void setCantidadPilada(Double cantidadPilada) {
		this.cantidadPilada = cantidadPilada;
	}
	...
	public Long getReferenciaUnitaria() {
		return this.referenciaUnitaria;
	}
