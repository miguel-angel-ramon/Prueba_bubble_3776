...
public class CamposSeleccionadosM implements Serializable {
    ...
    public CamposSeleccionadosM() {
		super();
	}

	public CamposSeleccionadosM(	int indice, 
			Long codArticulo, Long identificador, String seleccionado,
			String borrable,String esPlanograma, Long clasePedido, String noGestionaPbl, Long identificadorSIA) {
		super();
