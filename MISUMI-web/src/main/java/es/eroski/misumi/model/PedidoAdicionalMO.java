...
public class PedidoAdicionalMO implements Cloneable,Serializable{
	...
	public PedidoAdicionalMO() {
	    super();
	}
	
	public  PedidoAdicionalMO clone() throws CloneNotSupportedException{
		return (PedidoAdicionalMO)super.clone();
	}

	public PedidoAdicionalMO(Long codCentro, Long identificador, Long grupo1, Long grupo2, Long grupo3,
			...
			String oferta, int indice, String usuario, String modificable, String modificableIndiv, String tipoPedido,
			String borrable,String codError, String descError, String codigoRespuesta, String descripcionRespuesta, 
			List<CamposSeleccionadosMO> listadoSeleccionados, String noGestionaPbl, String descPeriodo,String espacioPromo, Long identificadorSIA) {
		super();
