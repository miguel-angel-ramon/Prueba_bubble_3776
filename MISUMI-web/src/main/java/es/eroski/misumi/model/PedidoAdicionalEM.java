...
public class PedidoAdicionalEM implements Cloneable,Serializable{
	...
	public PedidoAdicionalEM() {
	    super();
	}
	
	public  PedidoAdicionalEM clone() throws CloneNotSupportedException{
		return (PedidoAdicionalEM)super.clone();
	}

	public PedidoAdicionalEM(Long codCentro, Long identificador, Long grupo1, Long grupo2, Long grupo3,
			...
			List<CamposSeleccionadosEM> listadoSeleccionados, String noGestionaPbl, Long identificadorSIA) {
		super();
