/**
 * ExclusionVentaBorrarRequestType.java
 *
...
public class ExclusionVentaBorrarRequestType  implements java.io.Serializable {
    private es.eroski.misumi.model.pedidosPBLWS.ExclusionVentasType[] listaExclusionVentas;

    public ExclusionVentaBorrarRequestType() {
    }
    ...
    /**
     * Gets the listaExclusionVentas value for this ExclusionVentaBorrarRequestType.
     * 
    ...
    /**
     * Sets the listaExclusionVentas value for this ExclusionVentaBorrarRequestType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExclusionVentaBorrarRequestType)) return false;
        ExclusionVentaBorrarRequestType other = (ExclusionVentaBorrarRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExclusionVentaBorrarRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/ExclusionVentasPBL/ExclusionVentas", "ExclusionVentaBorrarRequestType"));
