...
public class ReferenciaResModType  implements java.io.Serializable {
    ...
    /**
     * Gets the grupoBalanza value for this ReferenciaResModType.
     * 
     * @return grupoBalanza
     */
    ...
    /**
     * Sets the grupoBalanza value for this ReferenciaResModType.
     * 
     * @param grupoBalanza
     */
    ...
    /**
     * Gets the PLU value for this ReferenciaResModType.
     * 
     * @return PLU
     */
    ...
    /**
     * Sets the PLU value for this ReferenciaResModType.
     * 
     * @param PLU
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/GCPV/schema/PLUSTienda", "ReferenciaResModType"));
