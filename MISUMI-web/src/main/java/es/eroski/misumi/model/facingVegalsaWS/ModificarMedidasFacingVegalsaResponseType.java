/**
 * ModificarMedidasFacingVegalsaResponseType.java
 *
...
public class ModificarMedidasFacingVegalsaResponseType  implements java.io.Serializable {
    ...
    private es.eroski.misumi.model.facingVegalsaWS.ReferenciaResMedidaType[] referencias;

    public ModificarMedidasFacingVegalsaResponseType() {
    }
    ...
    public ModificarMedidasFacingVegalsaResponseType(
           ...
           es.eroski.misumi.model.facingVegalsaWS.ReferenciaResMedidaType[] referencias) {
    ...
    /**
     * Gets the codigoRespuesta value for this ModificarMedidasFacingVegalsaResponseType.
     * 
    ...
    /**
     * Sets the codigoRespuesta value for this ModificarMedidasFacingVegalsaResponseType.
     * 
    ...
    /**
     * Gets the descripcionRespuesta value for this ModificarMedidasFacingVegalsaResponseType.
     * 
    ...
    /**
     * Sets the descripcionRespuesta value for this ModificarMedidasFacingVegalsaResponseType.
     * 
    ...
    /**
     * Gets the tipo value for this ModificarMedidasFacingVegalsaResponseType.
     * 
     * @return tipo
     */
    ...
    /**
     * Sets the tipo value for this ModificarMedidasFacingVegalsaResponseType.
     * 
     * @param tipo
     */
    ...
    /**
     * Gets the referencias value for this ModificarMedidasFacingVegalsaResponseType.
     * 
     * @return referencias
     */
    public es.eroski.misumi.model.facingVegalsaWS.ReferenciaResMedidaType[] getReferencias() {
        return referencias;
    }


    /**
     * Sets the referencias value for this ModificarMedidasFacingVegalsaResponseType.
     * 
     * @param referencias
     */
    public void setReferencias(es.eroski.misumi.model.facingVegalsaWS.ReferenciaResMedidaType[] referencias) {
        this.referencias = referencias;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ModificarMedidasFacingVegalsaResponseType)) return false;
        ModificarMedidasFacingVegalsaResponseType other = (ModificarMedidasFacingVegalsaResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ModificarMedidasFacingVegalsaResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/GCPV/schema/Facing", "ModificarMedidasFacingVegalsaResponseType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.eroski.es/GCPV/schema/Facing", "ReferenciaResMedidaType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
