...
public class VAgruComerRefPedidos implements Serializable{
	...
	public VAgruComerRefPedidos() {
	    super();
	}

	public VAgruComerRefPedidos(Long codCentro, String nivel, Long grupo1,
