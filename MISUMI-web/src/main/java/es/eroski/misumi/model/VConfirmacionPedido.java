...
public class VConfirmacionPedido implements Serializable{
	...
	public VConfirmacionPedido() {
		super();
	}

	public VConfirmacionPedido(Long codCentro, Long codPlat, Long codPedPlat,
			Long codPedAprovCentral, Date fechaTrans, Date fechaPed,
			Date fechaPrevisEnt, Long codArt, Float cajPed, Float uniServ,
			String tipoPed, String flgEnviadoPbl, Long grupo1, Long grupo2,
			Long grupo3, Long grupo4, Long grupo5, String descripArt,
			Float cajaNormal, Float cajaEmpuje, Float cajaImpl, Float cajaIntertienda) {
		super();
	...
	public VConfirmacionPedido(Long codCentro, Long codArt, Date fechaPrevisEnt,
			Float cajaNormal, Float cajaEmpuje, Float cajaImpl, Float cajaIntertienda) {
		super();
		this.codCentro = codCentro;
		this.fechaPrevisEnt = fechaPrevisEnt;
